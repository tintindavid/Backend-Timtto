...
export class OTController {
  async create(req, res, next) {
    try {
      const data = await oTService.create(req.body, req.tenantId);
  ...
  async update(req, res, next) {
    try {
      const data = await oTService.update(req.params.id, req.body, req.tenantId);
  ...
  async addEquipos(req, res, next) {
    try {
      const result = await oTService.addEquipos(req.params.id, req.body, req.tenantId);
